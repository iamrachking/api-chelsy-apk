        ...
        <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                       id="title" type="text" name="title" value="{{ old('title') }}" placeholder="Ex: Promotion spéciale">
                @error('title') 
            ...
            <div>
                <label class="block text-gray-700 text-sm font-semibold mb-2" for="image">
                    <i class="fas fa-image text-blue-500 mr-2"></i>Image * <span class="text-red-500">(Requis)</span>
                </label>
                <div class="mt-1 flex items-center space-x-5">
                    <label for="image" class="cursor-pointer flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                        ...
                        <input type="file" id="image" name="image" class="hidden" accept="image/*" required onchange="previewImage(this)">
                    </label>
                </div>
            ...
            <div>
                ...
                <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                       id="link" type="text" name="link" value="{{ old('link') }}" placeholder="Ex: /categories/1 ou https://example.com">
            ...
            <div>
                ...
                <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                       id="order" type="number" name="order" value="{{ old('order', 0) }}" min="0">
